...
class StatisticsChartWidgets {
  ...
  /// Build line chart data for weight progress
  static LineChartData _buildLineChartData(
    ...
    return LineChartData(
      ...
      gridData: FlGridData(
        ...
        horizontalInterval: (weightRange > 10 ? 5 : 2).toDouble(),
      ...
      titlesData: FlTitlesData(
        bottomTitles: AxisTitles(
          sideTitles: SideTitles(
            showTitles: true,
            reservedSize: 32,
            interval: (weightHistory.length / 5).ceil().toDouble(),
        ...
        leftTitles: AxisTitles(
          sideTitles: SideTitles(
            showTitles: true,
            reservedSize: 48,
            interval: (weightRange > 10 ? 5 : 2).toDouble(),
            getTitlesWidget: (value, meta) {
              return Container(
